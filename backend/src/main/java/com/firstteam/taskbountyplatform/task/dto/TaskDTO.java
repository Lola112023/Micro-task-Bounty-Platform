...
public class TaskDTO {
    ...
    private String publisherAnnouncement;
    private Double publisherCompletionRate;
    ...
    private String canApplyReason;
    private String remainingListTime;
    private String appealReason;
    private String appealResult;
    private String deliveryText;

    @JsonProperty("deliveryAttachments")
    private List<FileDTO> deliveryFiles;
    ...
    public String getPublisherAnnouncement() { return publisherAnnouncement; }
    public void setPublisherAnnouncement(String publisherAnnouncement) { this.publisherAnnouncement = publisherAnnouncement; }
    public Double getPublisherCompletionRate() { return publisherCompletionRate; }
    public void setPublisherCompletionRate(Double publisherCompletionRate) { this.publisherCompletionRate = publisherCompletionRate; }
    ...
    public Integer getListDays() { return listDays; }
    public void setListDays(Integer listDays) { this.listDays = listDays; }
    ...
    public Integer getExtendCount() { return extendCount; }
    public void setExtendCount(Integer extendCount) { this.extendCount = extendCount; }
    ...
    public String getMyApplicationStatus() { return myApplicationStatus; }
    public void setMyApplicationStatus(String myApplicationStatus) { this.myApplicationStatus = myApplicationStatus; }
    public boolean isCanApply() { return canApply; }
    public void setCanApply(boolean canApply) { this.canApply = canApply; }
    public String getCanApplyReason() { return canApplyReason; }
    public void setCanApplyReason(String canApplyReason) { this.canApplyReason = canApplyReason; }
    public String getRemainingListTime() { return remainingListTime; }
    public void setRemainingListTime(String remainingListTime) { this.remainingListTime = remainingListTime; }
    ...
    public List<FileDTO> getDeliveryFiles() { return deliveryFiles; }
    public void setDeliveryFiles(List<FileDTO> deliveryFiles) { this.deliveryFiles = deliveryFiles; }
}
